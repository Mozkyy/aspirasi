  ...
  <main class="flex-grow container mx-auto px-4 sm:px-10 py-10 flex flex-col lg:flex-row items-center justify-center gap-10 max-w-7xl">
   ...
   <section class="flex flex-col flex-2">
    <form class="flex flex-col gap-4">
     <input class="shadow-md rounded-md px-4 py-3 text-sm sm:text-base placeholder-[#999999] focus:outline-none" placeholder="Masukkan NIK Anda" type="text"/>
     <input class="shadow-md rounded-md px-4 py-3 text-sm sm:text-base placeholder-[#999999] focus:outline-none" placeholder="Masukkan Email Anda" type="email"/>
     <input class="shadow-md rounded-md px-4 py-3 text-sm sm:text-base placeholder-[#999999] focus:outline-none" placeholder="Password" type="password"/>
     <input class="shadow-md rounded-md px-4 py-3 text-sm sm:text-base placeholder-[#999999] focus:outline-none" placeholder="Konfirmasi Password" type="password"/>
     <label class="flex items-center gap-2 mt-2 select-none">
      <input class="w-5 h-5" type="checkbox"/>
      <span class="font-extrabold text-sm text-[#3a3a3a]">
       Ingatkan Saya
      </span>
     </label>
