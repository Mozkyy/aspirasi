                                    ...
                                    <form class="user" method="POST" action="{{ route('register.post') }}">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="name" class="form-control form-control-user"
                                                id="exampleInputName" placeholder="NAMA LENGKAP" value="{{ old('name') }}">
                                            @error('name')
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="nik" class="form-control form-control-user"
                                                id="exampleInputNIK" placeholder="NIK (16 digits)" value="{{ old('nik') }}" maxlength="16">
                                            @error('nik')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
